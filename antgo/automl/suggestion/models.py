...
class Study(object):
  ...
  def __init__(self, name, study_configuration, algorithm, mode='hyperparameter', status='stop', created_time=None, updated_time=None, flops=0.0):
    self.id = None
    self.name = name
