...
def running_statistic(running_block):
  ...
  running_gpu_mem_usage = [[now_gpu_status['gpu_mem_usage'][index] for index in now_gpu_status['occupy_gpus']]] \
                          if now_gpu_status is not None else []
  running_gpu_util = [[now_gpu_status['gpu_util'][index] for index in now_gpu_status['occupy_gpus']]] \
                      if now_gpu_status is not None else []
