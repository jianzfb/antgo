...
def get_build_flag_cpu():
    ...
    if config.USING_OPENCV:
        ...
        opencv_libs = ['opencv_calib3d', 'opencv_core', 'opencv_highgui', 'opencv_imgproc', 'opencv_imgcodecs', 'opencv_tracking', 'opencv_ximgproc', 'opencv_xfeatures2d', 'opencv_features2d']
